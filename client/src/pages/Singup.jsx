...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (passwordsMatch) {
      ...
      try {
        ...
        dispatch(singupActions.SingUpData({ SingUpData: response.data }));
  ...
  const handlePasswordChange = () => {
    setPasswordsMatch(
      passwordRef.current.value>6 === confirmPasswordRef.current.value
    );
  };
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-4">
              ...
              <input
                ...
                placeholder="password is required greater than 6 digits"
                className="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-600 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border border-solid py-1 px-4"
              />
            </div>
            <div className="mt-4">
              ...
              <input
                ...
                } shadow-sm focus:border-indigo-600 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border border-solid py-1 px-4`}
              />
              {!passwordsMatch && (
